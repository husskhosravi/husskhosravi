...
-  📚 I'm currently learning: Finetuning LLMs (via [DeepLearning.ai](https://www.deeplearning.ai)), dbt (Data Build Tool) for modular SQL transformations, testing, and scalable data pipelines in the warehouse
### 🧠 Recent Projects
